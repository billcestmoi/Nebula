...
public class tokensaleNebulaAiChineseTest {
    ...
    public void testTokenSaleCN_wallet() throws Exception {
        ...
        System.out.println("TokenSalePage  Wallet Test Pass");
        ...
        System.out.println("Medium Page Wallet Test Pass");
...
//        testTokenSaleCN_wallet();
    ...
    public void testTokenSaleCN_home() throws Exception {
        ...
        driver.findElement(By.xpath("//*[@id=\"translate\"]")).click();
        driver.findElement(By.xpath("/html/body/div[2]/div[1]/div[3]/div/ul/li[3]/a")).click();
...
// Switch back to original browser (first window)
    ...
    public void rest() throws Exception {
        ...
        /**
         * Tokensale footer test
         */
        driver.get("https://tokensale.nebula-ai.network/#footer");
        Thread.sleep(1000);
        assertEquals("tokensale@nebula-ai.com", driver.findElement(By.xpath("/html/body/div[13]/div[1]/div[3]/a")).getText());
...
//        driver.findElement(By.id("translate-home-login")).click();
//        Thread.sleep(5000);
//        System.out.println("The rest test finish");
//
//    }
