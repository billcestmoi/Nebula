...
public class tokensaleNebulaAiEnTest {
    ...
    @Test
    public void testTokenSaleEN_wallet() throws Exception {
    ...
    @Test
    public void testTokenSaleEN_home() throws Exception {
        // To test homepage
        //test whitepaper
        ...
        Thread.sleep(500);
        driver.findElement(By.xpath("//A[@href='https://nebula-ai.com/whitepaper/NBAI_whitepaper_EN.pdf']")).click();
        Thread.sleep(500);
        assertEquals("https://nebula-ai.com/whitepaper/NBAI_whitepaper_EN.pdf", driver.getCurrentUrl());
    ...
    @Test
    public void testTokenSaleEN_TopBar() throws Exception {
...
// come back home page
        ...
        Thread.sleep(1000);
        assertEquals("INTRODUCING", driver.findElement(By.cssSelector("html body div#about.about div.content div.header div#translate-about-intro.intro")).getText());
        //test 介绍
        driver.get(baseUrl);
        //driver.findElement(By.xpath("//*[@id=\"translate\"]")).click();
        ...
        Thread.sleep(1000);
        assertEquals("SMART ANALYSIS", driver.findElement(By.cssSelector("#translate-use-case-sub-title")).getText());
        //test 团队
        driver.get(baseUrl);
        //driver.findElement(By.xpath("//*[@id=\"translate\"]")).click();
        ...
        Thread.sleep(1000);
        assertEquals("OUR TEAM", driver.findElement(By.xpath("//*[@id=\"translate-team-title\"]")).getText());
        ...
        Thread.sleep(1000);
        assertEquals("Frequently Asked Questions", driver.findElement(By.xpath("//*[@id=\"translate-faq-title\"]")).getText());
...
// Switch back to original browser (first window)
    ...
    @Test
    public void restEN() throws Exception {
        driver.get(baseUrl);
        //driver.findElement(By.xpath("//*[@id=\"translate\"]")).click();
        Thread.sleep(500);
        driver.get("https://tokensale.nebula-ai.network/#roadmap");
        Thread.sleep(1000);
        assertEquals("BUSINESS ROADMAP", driver.findElement(By.xpath("//*[@id=\"translate-roadmap-title\"]")).getText());
        driver.findElement(By.xpath("/html/body/div[1]/ul/li[6]/a")).click();
        Thread.sleep(1000);
        assertEquals("TOKEN DISTRIBUTION", driver.findElement(By.xpath("//*[@id=\"translate-token-distribution-title\"]")).getText());
        ...
        Thread.sleep(1000);
        assertEquals("BLOCKCHAIN EXPERT", driver.findElement(By.xpath("/html/body/div[9]/div/div[2]/div/div[1]/div[2]/p/span")).getText());
        driver.findElement(By.xpath("/html/body/div[1]/ul/li[9]/a")).click();
        Thread.sleep(1000);
        assertEquals("OUR PARTNERS", driver.findElement(By.xpath("//*[@id=\"translate-partners-title\"]")).getText());
        driver.findElement(By.xpath("/html/body/div[1]/ul/li[10]/a")).click();
        Thread.sleep(1000);
        assertEquals("STRATEGIC INVESTORS", driver.findElement(By.xpath("//*[@id=\"translate-investors-title\"]")).getText());
